...
This repository is a generated artifact from [`reponomics/reponomics-dashboard-dev`](https://github.com/reponomics/reponomics-dashboard-dev). It is published for template consumers, not for direct development.
...
This repository does not accept direct pull requests for feature or runtime changes. If you need a change:
