...
> Only add a collaborator to a personal dashboard repository if you trust them not to compromise, disrupt, or take over the dashboard.

This is stronger than "would I be comfortable with this person reading dashboard data?" A collaborator in a personal-account repository may be able to affect secrets, workflow execution, generated outputs, and retained artifact continuity.
